...
env:
  IMAGE_TAG: sergeymeljnick78/myapp
  RELEASE_NAME: app-nginx
  NAMESPACE: netology
  ...
  deploy:
    ...
    steps:
      ...
      - name: Replace image tag in deployment.yaml
        ...
        run: |
          sed -i "s|image: sergeymeljnick78/myapp:.*|image: ${{ env.IMAGE_TAG }}|" ./deployment.yaml
        env:
          IMAGE_TAG: sergeymeljnick78/myapp:${{ env.VERSION }}
...
><http://178.154.206.245:32000> - grafana admin/admin
><http://178.154.206.245:32001> - static page
><http://178.154.206.245:31080> - staic page version - для наглядности работы ci/cd
